  ...
  if (loading) return (
    <div className="min-h-screen flex items-center justify-center bg-[#f4f6f4]">
      <div className="text-center">
        <img src="/logo.png" alt="Ganasoft" className="w-16 h-16 rounded-full object-cover mx-auto mb-4 shadow-lg" />
  ...
  const Sidebar = ({ mobile = false }: { mobile?: boolean }) => (
    <aside className={`${mobile ? 'w-72' : 'w-64'} flex flex-col h-full bg-[#0d1a0f]`}>
      ...
      <div className="flex items-center gap-3 px-6 py-5 border-b border-[#1c3020]">
        <img src="/logo.png" alt="Ganasoft" className="w-10 h-10 rounded-full object-cover flex-shrink-0 shadow-md" />
        <div>

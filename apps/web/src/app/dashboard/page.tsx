...
import { TrendingUp, CheckSquare, Syringe, ArrowUpRight, Activity, AlertCircle, HeartPulse, Baby, TreePine, BarChart3, Users } from 'lucide-react'
...
export default function DashboardPage() {
  ...
  const kpis = [
    { label: 'Total animales', value: data?.resumen.totalAnimales ?? 0, sub: 'en el inventario', icon: CowIcon, color: 'bg-green-600', href: '/dashboard/animales' },
    ...
    <div className="p-6 max-w-7xl space-y-6">
              ...
              return (
                <Link key={a.id} href={`/dashboard/animales/${a.id}`}
                  ...
                  <div className="w-9 h-9 rounded-xl bg-gray-100 flex items-center justify-center flex-shrink-0">
                    <CowIconclassName="w-4.5 h-4.5 text-gray-400" size={18} />
                  </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
        ...
        <div className="grid grid-cols-3 sm:grid-cols-5 lg:grid-cols-9 gap-3">
          {[
            { href: '/dashboard/animales', icon: CowIcon, label: 'Animales', color: 'text-campo-600 bg-campo-50' },
